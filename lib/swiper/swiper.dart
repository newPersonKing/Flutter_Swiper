...
import 'package:flutter_swiper/swiper/swiper_controller.dart';
import 'package:flutter_swiper/swiper/swiper_pagination.dart';
import 'dart:async';

import 'package:flutter_swiper/swiper/swiper_plugin.dart';
import 'package:flutter_swiper/transformer_page_view/index_controller.dart';
import 'package:flutter_swiper/transformer_page_view/transformer_page_view.dart';
...
class _SwiperState extends _SwiperTimerMixin {
  ...
  Widget _wrapTap(BuildContext context, int index) {
    /*HitTestBehavior.opaque 自己要处理点击事件*/
...
class _TinderState extends _CustomLayoutStateBase<_TinderSwiper> {
  ...
  Widget _buildItem(int i, int realIndex, double animationValue) {
    print("ccccccc==_TinderState===$realIndex");
...
class _StackViewState extends _CustomLayoutStateBase<_StackSwiper> {
  ...
  @override
  Widget _buildItem(int i, int realIndex, double animationValue) {
    print("cccccccccccc==_StackViewState===${realIndex}===$i===${widget.itemCount}");
    double s = _getValue(scales, animationValue, i);
