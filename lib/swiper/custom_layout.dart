...
abstract class _CustomLayoutStateBase<T extends _SubSwiper> extends State<T>
  ...
  Widget _buildAnimation(BuildContext context, Widget w) {
    ...
    print("ccccc==_buildAnimation===$_currentIndex==startIndex=$_startIndex=_animationCount=$_animationCount===${widget.itemCount}");
    double animationValue = _animation.value;


    for (int i = 0; i < _animationCount; ++i) {
      int realIndex = _currentIndex + i + _startIndex;
      print("ccccc==_buildAnimation=realIndex==$realIndex");
   ...
   /// HitTestBehavior 决定点击事件的传递方式 主要 方法 box中的hitTest 与 hitTestChildren
  ...
  /*滑动更新_animationController */
  /*todo 更新_animationController 会触发更新？？？*/
